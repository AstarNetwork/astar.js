...
export const checkIsDappRegistered = async ({ dappAddress,
  api }: {
  dappAddress: string;
  api: ApiPromise;
...
export const getNumberOfUnclaimedEra = async ({ dappAddress,
  api,
  senderAddress,
  currentEra }: {
  dappAddress: string;
...
const getContractEraStake = async ({ dappAddress,
  api,
  era }: {
  dappAddress: string;
  api: ApiPromise;
...
const eraSkippedZeroStake = async ({ dappAddress,
  api,
  currentEra,
  era }: {
  dappAddress: string;
...
const getTxsForClaimDapp = async ({ dappAddress,
  api,
  currentEra,
  senderAddress }: {
  dappAddress: string;
...
const getTxsForClaimStaker = async ({ dappAddress,
  api,
...
const getFirstEraDappHasNotClaimed = async ({ dappAddress,
  api,
  currentEra }: {
  dappAddress: string;
  api: ApiPromise;
...
const getLastEraClaimedForDapp = async ({ dappAddress,
  api,
  currentEra }: {
  dappAddress: string;
  api: ApiPromise;
...
export const getIndividualClaimTxs = async ({ dappAddress,
  senderAddress,
  api,
  currentEra }: {
  dappAddress: string;

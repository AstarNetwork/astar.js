...
export const mergeTvlArray = ({ ecosystem,
  dappStaking,
  base }: {
  ecosystem: number[][];
  dappStaking: number[][];
...
const getTvlValue = (tvlArray: number[][]) => {
...
export const getTvlData = async ({ network }: {
  network: string;
}): Promise<{
...
export const getClaimedAmount = async ({ network,
  account }: {
  network: string;
  account: string;
}): Promise<number> => {
...
export const fetchTransferDetails = async ({ hash,
  network }: {
  hash: string;
  network: string;
...
export const fetchXvmAssetsTransferHistories = async ({ senderAddress,
  contractAddress,
  network }: {
...
export const fetchDappsStats = async ({ dapp,
  network }: {
  dapp: string;
  network: string;
}): Promise<StatsDetail[]> => {

...
[Hardhat](https://hardhat.org)  plugin for interaction with [astar.js](https://github/com/webb-tools/astar.js).

## What

This plugin brings to hardhat the Astar library astar.js, which allows you to interact with the astar networks.

...
declare module '@polkadot/types/types/registry' {
  ...
  import type { ContractEventParamSpecV2 as ContractEventParamSpec, ContractEventSpecV2 as ContractEventSpec, ContractConstructorSpecV2 as ContractConstructorSpec, ContractContractSpecV2 as ContractContractSpec, ContractCryptoHasher, ContractDiscriminant, ContractDisplayName, ContractLayoutArray, ContractLayoutCell, ContractLayoutEnum, ContractLayoutHash, ContractLayoutHashingStrategy, ContractLayoutKey, ContractLayoutStruct, ContractLayoutStructField, ContractMessageParamSpecV2 as ContractMessageParamSpec, ContractMessageSpecV2 as ContractMessageSpec, ContractMetadata, ContractMetadataLatest, ContractMetadataV0, ContractMetadataV1, ContractProject, ContractProjectContract, ContractProjectInfo, ContractProjectSource, ContractProjectV0, ContractSelector, ContractStorageLayout, ContractTypeSpec } from '@polkadot/types/interfaces/contractsAbi';

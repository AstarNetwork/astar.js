...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    dappsStaking: {
       ...
       **/
      bondAndStake: AugmentedSubmittable<
        (
       ...
       **/
      burnStaleReward: AugmentedSubmittable<
        (
          contractId: AstarPrimitivesDappStakingSmartContract | { Evm: any } | { Wasm: any } | string | Uint8Array,
       ...
       **/
      claimDapp: AugmentedSubmittable<
        (
          contractId: AstarPrimitivesDappStakingSmartContract | { Evm: any } | { Wasm: any } | string | Uint8Array,
          era: Compact<u32> | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
       ...
       **/
      claimStaker: AugmentedSubmittable<
        (
          contractId: AstarPrimitivesDappStakingSmartContract | { Evm: any } | { Wasm: any } | string | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [AstarPrimitivesDappStakingSmartContract]
      ...
      maintenanceMode: AugmentedSubmittable<
        (enableMaintenance: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>,
        [bool]
      >;
      /**
      ...
      nominationTransfer: AugmentedSubmittable<
        (
          originContractId:
            ...
            | Uint8Array,
          value: Compact<u128> | AnyNumber | Uint8Array,
          targetContractId: AstarPrimitivesDappStakingSmartContract | { Evm: any } | { Wasm: any } | string | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [AstarPrimitivesDappStakingSmartContract, Compact<u128>, AstarPrimitivesDappStakingSmartContract]
      >;
      /**
      ...
      register: AugmentedSubmittable<
        (
          developer: AccountId32 | string | Uint8Array,
          contractId: AstarPrimitivesDappStakingSmartContract | { Evm: any } | { Wasm: any } | string | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
       ...
       * The dispatch origin must be Root.
       **/
      setContractStakeInfo: AugmentedSubmittable<
        (
          contract: AstarPrimitivesDappStakingSmartContract | { Evm: any } | { Wasm: any } | string | Uint8Array,
          era: u32 | AnyNumber | Uint8Array,
          contractStakeInfo:
            | PalletDappsStakingContractStakeInfo
            | { total?: any; numberOfStakers?: any; contractRewardClaimed?: any }
            | string
            | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [AstarPrimitivesDappStakingSmartContract, u32, PalletDappsStakingContractStakeInfo]
      >;
      /**
       ...
       **/
      setRewardDestination: AugmentedSubmittable<
        (
          rewardDestination: PalletDappsStakingRewardDestination | 'FreeBalance' | 'StakeBalance' | number | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [PalletDappsStakingRewardDestination]
      >;
      /**
       ...
       **/
      withdrawFromUnregistered: AugmentedSubmittable<
        (
          contractId: AstarPrimitivesDappStakingSmartContract | { Evm: any } | { Wasm: any } | string | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [AstarPrimitivesDappStakingSmartContract]
    ...
    inflation: {
       ...
       **/
      forceInflationRecalculation: AugmentedSubmittable<() => SubmittableExtrinsic<ApiType>, []>;
      /**

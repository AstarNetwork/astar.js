...
declare module '@polkadot/api-base/types/events' {
  export interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    xcAssetConfig: {
       ...
       **/
      AssetLocationChanged: AugmentedEvent<ApiType, [XcmVersionedMultiLocation, u128, XcmVersionedMultiLocation]>;
      /**
       * Registed mapping between asset type and asset Id.
       **/
      AssetRegistered: AugmentedEvent<ApiType, [XcmVersionedMultiLocation, u128]>;
      /**
       * Removed all information related to an asset Id
       **/
      AssetRemoved: AugmentedEvent<ApiType, [XcmVersionedMultiLocation, u128]>;
      /**
       * Supported asset type for fee payment removed.
       **/
      SupportedAssetRemoved: AugmentedEvent<ApiType, [XcmVersionedMultiLocation]>;
      /**
       * Changed the amount of units we are charging per execution second for an asset
       **/
      UnitsPerSecondChanged: AugmentedEvent<ApiType, [XcmVersionedMultiLocation, u128]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;

...
declare module '@polkadot/types/lookup' {
  ...
  interface PalletInflationInflationConfiguration extends Struct {
    readonly recalculationBlock: Compact<u32>;
  ...
  /** @name PalletDappStakingMigrationEvent (153) */
  interface PalletDappStakingMigrationEvent extends Enum {
    readonly isEntriesMigrated: boolean;
    readonly asEntriesMigrated: u32;
    readonly isEntriesDeleted: boolean;
    readonly asEntriesDeleted: u32;
    readonly type: 'EntriesMigrated' | 'EntriesDeleted';
  }

  /** @name PalletDappsStakingPalletEvent (154) */
  interface PalletDappsStakingPalletEvent extends Enum {
    readonly isBondAndStake: boolean;
    readonly asBondAndStake: ITuple<[AccountId32, AstarPrimitivesDappStakingSmartContract, u128]>;
    readonly isUnbondAndUnstake: boolean;
    readonly asUnbondAndUnstake: ITuple<[AccountId32, AstarPrimitivesDappStakingSmartContract, u128]>;
    readonly isWithdrawFromUnregistered: boolean;
    readonly asWithdrawFromUnregistered: ITuple<[AccountId32, AstarPrimitivesDappStakingSmartContract, u128]>;
    readonly isWithdrawn: boolean;
    readonly asWithdrawn: ITuple<[AccountId32, u128]>;
    readonly isNewContract: boolean;
    readonly asNewContract: ITuple<[AccountId32, AstarPrimitivesDappStakingSmartContract]>;
    readonly isContractRemoved: boolean;
    readonly asContractRemoved: ITuple<[AccountId32, AstarPrimitivesDappStakingSmartContract]>;
    readonly isNewDappStakingEra: boolean;
    readonly asNewDappStakingEra: u32;
    readonly isReward: boolean;
    readonly asReward: ITuple<[AccountId32, AstarPrimitivesDappStakingSmartContract, u32, u128]>;
    readonly isMaintenanceMode: boolean;
    readonly asMaintenanceMode: bool;
    readonly isRewardDestination: boolean;
    readonly asRewardDestination: ITuple<[AccountId32, PalletDappsStakingRewardDestination]>;
    readonly isNominationTransfer: boolean;
    readonly asNominationTransfer: ITuple<
      [AccountId32, AstarPrimitivesDappStakingSmartContract, u128, AstarPrimitivesDappStakingSmartContract]
    >;
    readonly isStaleRewardBurned: boolean;
    readonly asStaleRewardBurned: ITuple<[AccountId32, AstarPrimitivesDappStakingSmartContract, u32, u128]>;
    readonly type:
      | 'BondAndStake'
      | 'UnbondAndUnstake'
  ...
  /** @name PalletDappsStakingRewardDestination (155) */
  interface PalletDappsStakingRewardDestination extends Enum {
  ...
  /** @name CumulusPalletParachainSystemCall (227) */
  ...
  /** @name CumulusPrimitivesParachainInherentParachainInherentData (228) */
  ...
  /** @name PolkadotPrimitivesV4PersistedValidationData (229) */
  ...
  /** @name SpTrieStorageProof (231) */
  interface SpTrieStorageProof extends Struct {
    readonly trieNodes: BTreeSet<Bytes>;
  }

  /** @name PolkadotCorePrimitivesInboundDownwardMessage (234) */
  interface PolkadotCorePrimitivesInboundDownwardMessage extends Struct {
    readonly sentAt: u32;
    readonly msg: Bytes;
  }

  /** @name PolkadotCorePrimitivesInboundHrmpMessage (237) */
  interface PolkadotCorePrimitivesInboundHrmpMessage extends Struct {
    readonly sentAt: u32;
    readonly data: Bytes;
  }

  /** @name ParachainInfoCall (240) */
  type ParachainInfoCall = Null;

  /** @name PalletBalancesCall (241) */
  ...
  /** @name PalletDappStakingV3Call (244) */
  ...
  /** @name PalletInflationInflationParameters (246) */
  ...
  /** @name ShibuyaRuntimeSessionKeys (250) */
  ...
  /** @name SpCoreSr25519Public (252) */
  interface SpCoreSr25519Public extends U8aFixed {}

  /** @name CumulusPalletXcmpQueueCall (253) */
  ...
  /** @name XcmV2MultiassetMultiAssetFilter (263) */
  ...
  /** @name XcmV2MultiassetWildMultiAsset (264) */
  ...
  /** @name XcmV2MultiassetWildFungibility (265) */
  ...
  /** @name CumulusPalletDmpQueueCall (277) */
  ...
  /** @name PalletXcAssetConfigCall (278) */
  ...
  /** @name EthereumTransactionTransactionV2 (288) */
  ...
  /** @name EthereumTransactionLegacyTransaction (289) */
  ...
  /** @name EthereumTransactionTransactionAction (290) */
  ...
  /** @name EthereumTransactionTransactionSignature (291) */
  ...
  /** @name EthereumTransactionEip2930Transaction (293) */
  ...
  /** @name EthereumTransactionAccessListItem (295) */
  interface EthereumTransactionAccessListItem extends Struct {
    readonly address: H160;
    readonly storageKeys: Vec<H256>;
  }

  /** @name EthereumTransactionEip1559Transaction (296) */
  ...
  /** @name PalletDynamicEvmBaseFeeCall (297) */
  ...
  /** @name PalletEthereumCheckedCall (298) */
  ...
  /** @name AstarPrimitivesEthereumCheckedCheckedEthereumTx (299) */
  ...
  /** @name PalletUnifiedAccountsCall (302) */
  ...
  /** @name PalletContractsWasmDeterminism (306) */
  ...
  /** @name PalletDemocracyConviction (310) */
  ...
  /** @name PalletDappStakingMigrationCall (317) */
  interface PalletDappStakingMigrationCall extends Enum {
    readonly isMigrate: boolean;
    readonly asMigrate: {
  ...
  /** @name PalletDappsStakingPalletCall (318) */
  interface PalletDappsStakingPalletCall extends Enum {
    readonly isRegister: boolean;
    readonly asRegister: {
    ...
    readonly isNominationTransfer: boolean;
    readonly asNominationTransfer: {
      readonly originContractId: AstarPrimitivesDappStakingSmartContract;
      readonly value: Compact<u128>;
      readonly targetContractId: AstarPrimitivesDappStakingSmartContract;
    } & Struct;
    readonly isClaimStaker: boolean;
    readonly asClaimStaker: {
      readonly contractId: AstarPrimitivesDappStakingSmartContract;
    } & Struct;
    readonly isClaimDapp: boolean;
    readonly asClaimDapp: {
      readonly contractId: AstarPrimitivesDappStakingSmartContract;
      readonly era: Compact<u32>;
    } & Struct;
    ...
    readonly isMaintenanceMode: boolean;
    readonly asMaintenanceMode: {
      readonly enableMaintenance: bool;
    } & Struct;
    readonly isSetRewardDestination: boolean;
    readonly asSetRewardDestination: {
      readonly rewardDestination: PalletDappsStakingRewardDestination;
    } & Struct;
    readonly isSetContractStakeInfo: boolean;
    readonly asSetContractStakeInfo: {
      readonly contract: AstarPrimitivesDappStakingSmartContract;
      readonly era: u32;
      readonly contractStakeInfo: PalletDappsStakingContractStakeInfo;
    } & Struct;
    readonly isBurnStaleReward: boolean;
    readonly asBurnStaleReward: {
      readonly contractId: AstarPrimitivesDappStakingSmartContract;
      readonly era: Compact<u32>;
    } & Struct;
    readonly type:
  ...
  /** @name PalletDappsStakingContractStakeInfo (319) */
  interface PalletDappsStakingContractStakeInfo extends Struct {
    readonly total: Compact<u128>;
    readonly numberOfStakers: Compact<u32>;
    readonly contractRewardClaimed: bool;
  }

  /** @name ShibuyaRuntimeOriginCaller (320) */
  ...
  /** @name PalletEthereumRawOrigin (324) */
  ...
  /** @name PalletEthereumCheckedRawOrigin (325) */
  ...
  /** @name PalletCollectiveRawOrigin (326) */
  ...
  /** @name PalletIdentityRegistration (330) */
  ...
  /** @name PalletIdentityRegistrarInfo (338) */
  ...
  /** @name PalletSchedulerScheduled (348) */
  ...
  /** @name PolkadotPrimitivesV4UpgradeRestriction (361) */
  interface PolkadotPrimitivesV4UpgradeRestriction extends Enum {
    readonly isPresent: boolean;
    readonly type: 'Present';
  }

  /** @name CumulusPalletParachainSystemRelayStateSnapshotMessagingStateSnapshot (362) */
  ...
  /** @name CumulusPalletParachainSystemRelayStateSnapshotRelayDispachQueueSize (363) */
  interface CumulusPalletParachainSystemRelayStateSnapshotRelayDispachQueueSize extends Struct {
    readonly remainingCount: u32;
    readonly remainingSize: u32;
  }

  /** @name PolkadotPrimitivesV4AbridgedHrmpChannel (366) */
  ...
  /** @name PolkadotPrimitivesV4AbridgedHostConfiguration (367) */
  ...
  /** @name PolkadotCorePrimitivesOutboundHrmpMessage (373) */
  interface PolkadotCorePrimitivesOutboundHrmpMessage extends Struct {
    readonly recipient: u32;
    readonly data: Bytes;
  }

  /** @name CumulusPalletParachainSystemCodeUpgradeAuthorization (374) */
  interface CumulusPalletParachainSystemCodeUpgradeAuthorization extends Struct {
    readonly codeHash: H256;
    readonly checkVersion: bool;
  }

  /** @name CumulusPalletParachainSystemError (375) */
  ...
  /** @name PalletBalancesBalanceLock (379) */
  ...
  /** @name PalletBalancesReasons (380) */
  ...
  /** @name PalletBalancesReserveData (383) */
  interface PalletBalancesReserveData extends Struct {
    readonly id: U8aFixed;
    readonly amount: u128;
  }

  /** @name PalletBalancesIdAmount (389) */
  interface PalletBalancesIdAmount extends Struct {
    readonly id: ShibuyaRuntimeRuntimeFreezeReason;
    readonly amount: u128;
  }

  /** @name ShibuyaRuntimeRuntimeFreezeReason (390) */
  ...
  /** @name PalletDappStakingV3FreezeReason (391) */
  interface PalletDappStakingV3FreezeReason extends Enum {
    readonly isDAppStaking: boolean;
    readonly type: 'DAppStaking';
  }

  /** @name PalletBalancesError (393) */
  ...
  /** @name PalletVestingReleases (396) */
  ...
  /** @name PalletDappStakingV3ProtocolState (398) */
  ...
  /** @name PalletDappStakingV3PeriodInfo (399) */
  ...
  /** @name PalletDappStakingV3DAppInfo (400) */
  ...
  /** @name PalletDappStakingV3DAppState (402) */
  ...
  /** @name PalletDappStakingV3AccountLedger (403) */
  ...
  /** @name PalletDappStakingV3EraRewardSpan (413) */
  ...
  /** @name PalletDappStakingV3EraReward (415) */
  ...
  /** @name PalletDappStakingV3PeriodEndInfo (417) */
  ...
  /** @name PalletDappStakingV3TierParameters (418) */
  ...
  /** @name PalletDappStakingV3TierThreshold (423) */
  ...
  /** @name PalletDappStakingV3TiersConfiguration (425) */
  ...
  /** @name PalletDappStakingV3DAppTierRewards (428) */
  ...
  /** @name PalletDappStakingV3Error (436) */
  interface PalletDappStakingV3Error extends Enum {
    ...
    readonly isDAppRewardAlreadyClaimed: boolean;
  ...
  /** @name PalletAssetsAssetDetails (438) */
  ...
  /** @name PalletAssetsAssetStatus (439) */
  ...
  /** @name PalletAssetsAssetAccount (441) */
  ...
  /** @name PalletAssetsAccountStatus (442) */
  ...
  /** @name PalletAssetsExistenceReason (443) */
  ...
  /** @name PalletAssetsApproval (445) */
  interface PalletAssetsApproval extends Struct {
    readonly amount: u128;
    readonly deposit: u128;
  }

  /** @name PalletAssetsAssetMetadata (446) */
  ...
  /** @name PalletCollatorSelectionCandidateInfo (450) */
  interface PalletCollatorSelectionCandidateInfo extends Struct {
    readonly who: AccountId32;
    readonly deposit: u128;
  }

  /** @name PalletCollatorSelectionError (451) */
  ...
  /** @name SpCoreCryptoKeyTypeId (456) */
  interface SpCoreCryptoKeyTypeId extends U8aFixed {}

  /** @name PalletSessionError (457) */
  ...
  /** @name PalletXcmVersionMigrationStage (485) */
  ...
  /** @name PalletXcmRemoteLockedFungibleRecord (489) */
  ...
  /** @name CumulusPalletXcmError (497) */
  type CumulusPalletXcmError = Null;

  /** @name CumulusPalletDmpQueueConfigData (498) */
  interface CumulusPalletDmpQueueConfigData extends Struct {
    readonly maxIndividual: SpWeightsWeightV2Weight;
  }

  /** @name CumulusPalletDmpQueuePageIndexData (499) */
  ...
  /** @name CumulusPalletDmpQueueError (502) */
  ...
  /** @name PalletXcAssetConfigError (503) */
  ...
  /** @name FpRpcTransactionStatus (510) */
  ...
  /** @name EthbloomBloom (513) */
  interface EthbloomBloom extends U8aFixed {}

  /** @name EthereumReceiptReceiptV3 (515) */
  ...
  /** @name EthereumReceiptEip658ReceiptData (516) */
  ...
  /** @name EthereumTypesHashH64 (519) */
  interface EthereumTypesHashH64 extends U8aFixed {}

  /** @name PalletEthereumError (524) */
  ...
  /** @name PalletContractsWasmPrefabWasmModule (528) */
  ...
  /** @name PalletContractsWasmOwnerInfo (530) */
  ...
  /** @name PalletContractsStorageContractInfo (531) */
  ...
  /** @name PalletContractsScheduleLimits (536) */
  ...
  /** @name PalletContractsScheduleInstructionWeights (537) */
  ...
  /** @name PalletContractsScheduleHostFnWeights (538) */
  ...
  /** @name PalletDemocracyReferendumInfo (544) */
  ...
  /** @name PalletDemocracyReferendumStatus (545) */
  ...
  /** @name PalletDemocracyVoteVoting (547) */
  ...
  /** @name PalletDemocracyDelegations (551) */
  interface PalletDemocracyDelegations extends Struct {
    readonly votes: u128;
    readonly capital: u128;
  }

  /** @name PalletDemocracyVotePriorLock (552) */
  interface PalletDemocracyVotePriorLock extends ITuple<[u32, u128]> {}

  /** @name PalletDemocracyError (555) */
  ...
  /** @name PalletTreasuryProposal (560) */
  ...
  /** @name FrameSupportPalletId (563) */
  interface FrameSupportPalletId extends U8aFixed {}

  /** @name PalletTreasuryError (564) */
  ...
  /** @name PalletPreimageRequestStatus (565) */
  ...
  /** @name PalletSudoError (571) */
  interface PalletSudoError extends Enum {
    readonly isRequireSudo: boolean;
    readonly type: 'RequireSudo';
  }

  /** @name PalletDappStakingMigrationMigrationState (572) */
  interface PalletDappStakingMigrationMigrationState extends Enum {
    readonly isNotInProgress: boolean;
    readonly isRegisteredDApps: boolean;
    readonly isLedgers: boolean;
    readonly isCleanup: boolean;
    readonly isFinished: boolean;
    readonly type: 'NotInProgress' | 'RegisteredDApps' | 'Ledgers' | 'Cleanup' | 'Finished';
  }

  /** @name PalletDappsStakingAccountLedger (573) */
  interface PalletDappsStakingAccountLedger extends Struct {
    readonly locked: Compact<u128>;
    readonly unbondingInfo: PalletDappsStakingUnbondingInfo;
    readonly rewardDestination: PalletDappsStakingRewardDestination;
  }

  /** @name PalletDappsStakingUnbondingInfo (574) */
  interface PalletDappsStakingUnbondingInfo extends Struct {
    readonly unlockingChunks: Vec<PalletDappsStakingUnlockingChunk>;
  }

  /** @name PalletDappsStakingUnlockingChunk (576) */
  interface PalletDappsStakingUnlockingChunk extends Struct {
    readonly amount: Compact<u128>;
    readonly unlockEra: Compact<u32>;
  }

  /** @name PalletDappsStakingRewardInfo (577) */
  interface PalletDappsStakingRewardInfo extends Struct {
    readonly stakers: Compact<u128>;
    readonly dapps: Compact<u128>;
  }

  /** @name PalletDappsStakingForcing (578) */
  interface PalletDappsStakingForcing extends Enum {
    readonly isNotForcing: boolean;
    readonly isForceNew: boolean;
    readonly type: 'NotForcing' | 'ForceNew';
  }

  /** @name PalletDappsStakingDAppInfo (579) */
  interface PalletDappsStakingDAppInfo extends Struct {
    readonly developer: AccountId32;
    readonly state: PalletDappsStakingDAppState;
  }

  /** @name PalletDappsStakingDAppState (580) */
  interface PalletDappsStakingDAppState extends Enum {
    readonly isRegistered: boolean;
    readonly isUnregistered: boolean;
  ...
  /** @name PalletDappsStakingEraInfo (581) */
  interface PalletDappsStakingEraInfo extends Struct {
    readonly rewards: PalletDappsStakingRewardInfo;
    readonly staked: Compact<u128>;
    readonly locked: Compact<u128>;
  }

  /** @name PalletDappsStakingStakerInfo (583) */
  interface PalletDappsStakingStakerInfo extends Struct {
    readonly stakes: Vec<PalletDappsStakingEraStake>;
  }

  /** @name PalletDappsStakingEraStake (585) */
  interface PalletDappsStakingEraStake extends Struct {
    readonly staked: Compact<u128>;
    readonly era: Compact<u32>;
  }

  /** @name PalletDappsStakingVersion (586) */
  interface PalletDappsStakingVersion extends Enum {
    readonly isV100: boolean;
    readonly isV200: boolean;
    readonly isV300: boolean;
    readonly isV400: boolean;
    readonly type: 'V100' | 'V200' | 'V300' | 'V400';
  }

  /** @name PalletDappsStakingPalletError (587) */
  interface PalletDappsStakingPalletError extends Enum {
    readonly isDisabled: boolean;
    readonly isNoMaintenanceModeChange: boolean;
    readonly isUpgradeTooHeavy: boolean;
    ...
    readonly isNotUnregisteredContract: boolean;
    ...
    readonly isNotActiveStaker: boolean;
    readonly isNominationTransferToSameContract: boolean;
    readonly type:
      | 'Disabled'
  ...
  /** @name SpRuntimeMultiSignature (589) */
  ...
  /** @name SpCoreEd25519Signature (590) */
  interface SpCoreEd25519Signature extends U8aFixed {}

  /** @name SpCoreSr25519Signature (592) */
  interface SpCoreSr25519Signature extends U8aFixed {}

  /** @name SpCoreEcdsaSignature (593) */
  interface SpCoreEcdsaSignature extends U8aFixed {}

  /** @name FrameSystemExtensionsCheckSpecVersion (595) */
  type FrameSystemExtensionsCheckSpecVersion = Null;

  /** @name FrameSystemExtensionsCheckTxVersion (596) */
  type FrameSystemExtensionsCheckTxVersion = Null;

  /** @name FrameSystemExtensionsCheckGenesis (597) */
  type FrameSystemExtensionsCheckGenesis = Null;

  /** @name FrameSystemExtensionsCheckNonce (600) */
  interface FrameSystemExtensionsCheckNonce extends Compact<u32> {}

  /** @name FrameSystemExtensionsCheckWeight (601) */
  type FrameSystemExtensionsCheckWeight = Null;

  /** @name PalletTransactionPaymentChargeTransactionPayment (602) */

...
import type { CumulusPalletDmpQueueConfigData, CumulusPalletDmpQueuePageIndexData, CumulusPalletParachainSystemRelayStateSnapshotMessagingStateSnapshot, CumulusPalletXcmpQueueInboundChannelDetails, CumulusPalletXcmpQueueOutboundChannelDetails, CumulusPalletXcmpQueueQueueConfigData, EthereumBlock, EthereumReceiptReceiptV3, EthereumTransactionTransactionV2, FpRpcTransactionStatus, FrameSupportDispatchPerDispatchClassWeight, FrameSupportPreimagesBounded, FrameSystemAccountInfo, FrameSystemEventRecord, FrameSystemLastRuntimeUpgradeInfo, FrameSystemPhase, PalletAssetsApproval, PalletAssetsAssetAccount, PalletAssetsAssetDetails, PalletAssetsAssetMetadata, PalletAuthorshipUncleEntryItem, PalletBalancesAccountData, PalletBalancesBalanceLock, PalletBalancesReserveData, PalletBlockRewardRewardDistributionConfig, PalletCollatorSelectionCandidateInfo, PalletCollectiveVotes, PalletContractsMigrationMigrationState, PalletContractsStorageContractInfo, PalletContractsStorageDeletedContract, PalletContractsWasmOwnerInfo, PalletContractsWasmPrefabWasmModule, PalletDappsStakingAccountLedger, PalletDappsStakingContractStakeInfo, PalletDappsStakingDAppInfo, PalletDappsStakingEraInfo, PalletDappsStakingForcing, PalletDappsStakingRewardInfo, PalletDappsStakingStakerInfo, PalletDappsStakingVersion, PalletDemocracyReferendumInfo, PalletDemocracyVoteThreshold, PalletDemocracyVoteVoting, PalletIdentityRegistrarInfo, PalletIdentityRegistration, PalletMultisigMultisig, PalletPreimageRequestStatus, PalletProxyAnnouncement, PalletProxyProxyDefinition, PalletSchedulerScheduled, PalletTransactionPaymentReleases, PalletTreasuryProposal, PalletVestingReleases, PalletVestingVestingInfo, PalletXcmQueryStatus, PalletXcmVersionMigrationStage, PolkadotCorePrimitivesOutboundHrmpMessage, PolkadotPrimitivesV2AbridgedHostConfiguration, PolkadotPrimitivesV2PersistedValidationData, PolkadotPrimitivesV2UpgradeRestriction, ShibuyaRuntimeSessionKeys, ShibuyaRuntimeSmartContract, SpConsensusAuraSr25519AppSr25519Public, SpCoreCryptoKeyTypeId, SpRuntimeDigest, SpTrieStorageProof, SpWeightsWeightV2Weight, XcmVersionedMultiLocation } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    blockReward: {
      rewardDistributionConfigStorage: AugmentedQuery<ApiType, () => Observable<PalletBlockRewardRewardDistributionConfig>, []>;
    };
    collatorSelection: {
      /**
    ...
    contractsMigration: {
      migrationStateStorage: AugmentedQuery<ApiType, () => Observable<PalletContractsMigrationMigrationState>, []>;
    };
    council: {
      /**
    ...
    dappsStaking: {
       ...
       **/
      blockRewardAccumulator: AugmentedQuery<ApiType, () => Observable<PalletDappsStakingRewardInfo>, []>;
      /**
       * Staking information about contract in a particular era.
       **/
      contractEraStake: AugmentedQuery<ApiType, (arg1: ShibuyaRuntimeSmartContract | { Evm: any } | { Wasm: any } | string | Uint8Array, arg2: u32 | AnyNumber | Uint8Array) => Observable<Option<PalletDappsStakingContractStakeInfo>>, [ShibuyaRuntimeSmartContract, u32]>;
      /**
       ...
       * Mode of era forcing.
       **/
      forceEra: AugmentedQuery<ApiType, () => Observable<PalletDappsStakingForcing>, []>;
      /**
       * General information about an era like TVL, total staked value, rewards.
       **/
      generalEraInfo: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<PalletDappsStakingEraInfo>>, [u32]>;
      /**
       * Info about stakers stakes on particular contracts.
       **/
      generalStakerInfo: AugmentedQuery<ApiType, (arg1: AccountId32 | string | Uint8Array, arg2: ShibuyaRuntimeSmartContract | { Evm: any } | { Wasm: any } | string | Uint8Array) => Observable<PalletDappsStakingStakerInfo>, [AccountId32, ShibuyaRuntimeSmartContract]>;
      /**
       * General information about the staker (non-smart-contract specific).
       **/
      ledger: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<PalletDappsStakingAccountLedger>, [AccountId32]>;
      /**
       ...
       **/
      palletDisabled: AugmentedQuery<ApiType, () => Observable<bool>, []>;
      /**
       * Simple map where smart contract points to basic info about it (e.g. developer address, state)
       **/
      registeredDapps: AugmentedQuery<ApiType, (arg: ShibuyaRuntimeSmartContract | { Evm: any } | { Wasm: any } | string | Uint8Array) => Observable<Option<PalletDappsStakingDAppInfo>>, [ShibuyaRuntimeSmartContract]>;
      /**
       * Simple map where developer account points to their smart contract
       **/
      registeredDevelopers: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<ShibuyaRuntimeSmartContract>>, [AccountId32]>;
      /**
       * Stores the current pallet storage version.
       **/
      storageVersion: AugmentedQuery<ApiType, () => Observable<PalletDappsStakingVersion>, []>;
    };
    democracy: {
      /**
    ...
    session: {
       ...
       **/
      nextKeys: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<ShibuyaRuntimeSessionKeys>>, [AccountId32]>;
      /**
    ...
    xcAssetConfig: {
       ...
       **/
      assetIdToLocation: AugmentedQuery<ApiType, (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<XcmVersionedMultiLocation>>, [u128]>;
      /**
       * Mapping from an asset type to an asset id.
       * Can be used when receiving a multilocation XCM message to retrieve
       * the corresponding asset in which tokens should me minted.
       **/
      assetLocationToId: AugmentedQuery<ApiType, (arg: XcmVersionedMultiLocation | { V0: any } | { V1: any } | string | Uint8Array) => Observable<Option<u128>>, [XcmVersionedMultiLocation]>;
      /**
       ...
       **/
      assetLocationUnitsPerSecond: AugmentedQuery<ApiType, (arg: XcmVersionedMultiLocation | { V0: any } | { V1: any } | string | Uint8Array) => Observable<Option<u128>>, [XcmVersionedMultiLocation]>;
    };
    xcmpQueue: {
      /**

...
import { PalletDappsStakingForcing } from './runtime';
...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    dappsStaking: {
       ...
       **/
      contractEraStake: AugmentedQuery<
        ApiType,
        (
          arg1: AstarPrimitivesDappStakingSmartContract | { Evm: any } | { Wasm: any } | string | Uint8Array,
          arg2: u32 | AnyNumber | Uint8Array
        ) => Observable<Option<PalletDappsStakingContractStakeInfo>>,
        [AstarPrimitivesDappStakingSmartContract, u32]
      > &
        QueryableStorageEntry<ApiType, [AstarPrimitivesDappStakingSmartContract, u32]>;
      /**
       ...
       **/
      generalEraInfo: AugmentedQuery<
        ApiType,
        (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<PalletDappsStakingEraInfo>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>;
      /**
      ...
      ledger: AugmentedQuery<
        ApiType,
        (arg: AccountId32 | string | Uint8Array) => Observable<PalletDappsStakingAccountLedger>,
        [AccountId32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       ...
       **/
      registeredDevelopers: AugmentedQuery<
        ApiType,
        (arg: AccountId32 | string | Uint8Array) => Observable<Option<AstarPrimitivesDappStakingSmartContract>>,
        [AccountId32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
    ...
    dappStaking: {
       ...
       **/
      counterForIntegratedDApps: AugmentedQuery<ApiType, () => Observable<u32>, []> &
        QueryableStorageEntry<ApiType, []>;
      /**
    ...
    dappStakingMigration: {
       ...
       **/
      migrationStateStorage: AugmentedQuery<ApiType, () => Observable<PalletDappStakingMigrationMigrationState>, []> &
        QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
